 ...
 */
export function resample(input, from_rate, to_rate) {
    const ptr0 = passArrayF32ToWasm0(input, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.resample(ptr0, len0, from_rate, to_rate);
 ...
 * @param {number} target_dbfs
 * @param {number} peak_ceiling
 * @returns {Uint8Array}
 */
export function render_wav(pcm, target_dbfs, peak_ceiling) {
    const ptr0 = passArrayF32ToWasm0(pcm, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.render_wav(ptr0, len0, target_dbfs, peak_ceiling);
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v2;
}

const PerceptEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_perceptengine_free(ptr >>> 0, 1));
/**
...
export class PerceptEngine {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        PerceptEngineFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_perceptengine_free(ptr, 0);
    }
    /**
    ...
    feed_frame(frame) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.perceptengine_feed_frame(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     ...
     */
    take_segment() {
        const ret = wasm.perceptengine_take_segment(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
     ...
     */
    list_speakers() {
        const ret = wasm.perceptengine_list_speakers(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     * @param {string} name
     */
    rename_speaker(id, name) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.perceptengine_rename_speaker(this.__wbg_ptr, id, ptr0, len0);
    }
    /**
     ...
     * @returns {any}
     */
    analyze_segment(pcm, target_dbfs) {
        const ptr0 = passArrayF32ToWasm0(pcm, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.perceptengine_analyze_segment(this.__wbg_ptr, ptr0, len0, target_dbfs);
        return ret;
    }
    constructor() {
        const ret = wasm.perceptengine_new();
        this.__wbg_ptr = ret >>> 0;
        PerceptEngineFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    flush() {
        const ret = wasm.perceptengine_flush(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    reset() {
        wasm.perceptengine_reset(this.__wbg_ptr);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('percept_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
